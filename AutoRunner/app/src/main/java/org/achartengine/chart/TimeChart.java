...
public class TimeChart extends LineChart {
    ...
    private DateFormat getDateFormat(double start, double end) {
        if (mDateFormat != null) {
            ...
            try {
                format = new SimpleDateFormat(mDateFormat, mLocale);
                return format;
            }
            catch (Exception e) {
                // do nothing here
        ...
        DateFormat format = SimpleDateFormat.getDateInstance(SimpleDateFormat.MEDIUM, mLocale);
        ...
        if (diff > DAY && diff < 5 * DAY) {
            ...
            format = SimpleDateFormat.getTimeInstance(SimpleDateFormat.MEDIUM, mLocale);
        }
        return format;
    }
