...
public class LineChart extends XYChart {
    ...
    protected ClickableArea[] clickableAreasForPoints(List<Float> points, List<Double> values,
        ...
        for (int i = 0; i < length; i += 2) {
            ...
            ret[i / 2] = new ClickableArea(
                    new RectF(points.get(i) - selectableBuffer,
                            points.get(i + 1) - selectableBuffer, points.get(i) + selectableBuffer,
                            points.get(i + 1) + selectableBuffer),
