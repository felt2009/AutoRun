...
public class XYMultipleSeriesRenderer extends DefaultRenderer {
    ...
    /**
     * Sets the zoom in limit permitted in the axis X. This function prevent
     * that the distance between {@link #getXAxisMin()} and
    ...
    /**
     * Sets zoom in limit permitted in the axis Y. This function prevent that
     * the distance between {@link #getYAxisMin()} and {@link #getYAxisMax()}
     * can't be greater or equal than {@link #getZoomInLimitY()}
